...
class DespesaNewView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final int eventoId = args['eventoId'];
    final int editId = args['editId'];

    ctrl.manageEvento(eventoId, editId);
    ...
    return AppScaffold(
      ...
      body: Column( children: [
        Padding(
          ...
          child: Obx(() =>Text('Despesa em ${ctrl.nomeEv.value}', style: Theme.of(context).textTheme.titleLarge)),
        ),
        ListTile(
        ...
        ListTile(
          ...
          title: const Text('Pago por:', style: TextStyle(fontSize: 13)),
          subtitle: Obx(() {
            ...
            bool existeNaLista = ctrl.lstPagador.any((item) => item.value == valorAtual);

            return DropdownButtonFormField<String>(
              hint: const Text('Participante'),
              value: existeNaLista ? valorAtual : null, // Só passa se for válido
              isExpanded: true,

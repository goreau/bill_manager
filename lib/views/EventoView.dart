...
class EventoView extends StatelessWidget {
  final EventoController ctrl = Get.put(EventoController());
  ...
  Widget build(BuildContext context) {
    ...
    // Chama o método para forçar a atualização dos dados
    ctrl.prepararTela(id);
    return AppScaffold(
      title: 'Bill Manager',
        ...
        child: Column(
          children: <Widget>[
            Padding(
              ...
              child: Text('Novo Evento', style: Theme.of(context).textTheme.titleLarge),
            ),
            ListTile(
              title: Text(
                'Nome do Evento:',
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      if (ctrl.participanteController.text.isNotEmpty) {
                        ...
                        ctrl.participanteController.clear(); // Limpa o campo
                      }
                    },
                  ),
                ],
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    ...
                    trailing: IconButton(
                      ...
                      onPressed: () => ctrl.listaParticipantes.removeAt(index),
                    ),
                  );
                },
              ),
        ...
        child: ClipRRect(
          ...
          child: Obx(() {
            ...
            if (ctrl.imagem.value.isEmpty) {
              ...
              return Image.file(
                File(ctrl.imagem.value),
                fit: BoxFit.cover,
                height: 200,
                width: double.infinity, // Garante que preencha a largura
              );
            }
          }),
        ),
            ...
            Container(
              ...
              child: SizedBox(
                ...
                child: FilledButton(
                  onPressed: () async {
                    await ctrl.salvarEventoCompleto(context);
                  },
                  child: Text('Salvar'),
                ),
              ),
